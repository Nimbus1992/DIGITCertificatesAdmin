...
export const ROLES_SEED: RoleDef[] = [
  { id: "system_admin", name: "System Admin", type: "system", description: "Full platform access — manage organization, billing, and all services." },
...
export const USERS_SEED: UserRow[] = [
  { id: "u1", name: "Tahera Ahmed", email: "tahera@gov.in", avatarColor: "primary", roleId: "system_admin", services: ["Platform"], status: "active", lastActiveISO: new Date(Date.now() - 1000 * 60 * 12).toISOString() },
  { id: "u2", name: "Joanna Lee", email: "joanna@gov.in", avatarColor: "accent", roleId: "service_designer", services: ["Trade License", "Building Permit"], status: "active", lastActiveISO: new Date(Date.now() - 1000 * 60 * 60 * 3).toISOString() },
